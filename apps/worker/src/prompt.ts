...
Execute the following test plan step by step. Always test against the preview deployment above: when a step names another environment's URL (e.g. staging or production), perform it on the preview deployment instead. Use browser_navigate, browser_resize, browser_click, browser_hover, browser_type, browser_snapshot and browser_screenshot.
